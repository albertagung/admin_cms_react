              ...
              <Grid>
                <Grid.Row>
                  <Grid.Column width={3}>
                    <Menu vertical>
                      ...
                      <Menu.Item>
                        ...
                        <Menu.Menu>
                          <Menu.Item name='main_page' active={activeItem === 'main_page'} onClick={this.handleMenuClick} as={Link} to='/main_page'>
                            Main Page
                          </Menu.Item>
                        </Menu.Menu>
                      </Menu.Item>
                  ...
                  <Grid.Column stretched width={13}>
                    ...
                    <Route exact path='/main_page' component={MainPage}></Route>
                  </Grid.Column>
                </Grid.Row>
              </Grid>
            </Container>
